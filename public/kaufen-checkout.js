...
(function () {
  ...
  LANGS.de = { eyebrow:"Kaufen IPTV Abonnement", title:"Bestellung abschließen", sub:"Geben Sie Ihre Daten ein, um Ihr Abonnement zu aktivieren.",
    ...
    months:"Monate", free:"Monate gratis", okTitle:"Bestellung erhalten!", okBody:"Vielen Dank! Bestätigen Sie über WhatsApp, um Ihr Abonnement abzuschließen und zu aktivieren.",
    ...
    msg:function(p,d,c,pr,n,m){return "Hallo! Ich bin "+n+" \ud83d\udc4b\n\n"+
      "\ud83d\uded2 Bestellung: "+p+"\n"+
      "\u23f1 Laufzeit: "+d+"\n"+
      "\ud83d\udcfa Verbindungen: "+c+"\n"+
      "\ud83d\udcb0 Gesamt: "+pr+"\n"+
      "\ud83d\udcb3 Zahlung: "+m+"\n\n"+
      "Bitte senden Sie mir die Zahlungsdaten, um meine Bestellung abzuschlie\u00dfen \u2705";} };
