...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: { path: string; priority: number; freq: "weekly" | "monthly" | "daily" }[] = [
    ...
    { path: "/iptv-kaufen", priority: 0.95, freq: "weekly" },
    { path: "/preise", priority: 0.9, freq: "weekly" },
    { path: "/beste-iptv-anbieter", priority: 0.85, freq: "weekly" },
    { path: "/iptv-anbieter", priority: 0.8, freq: "weekly" },
    { path: "/iptv-box-kaufen", priority: 0.8, freq: "weekly" },
    { path: "/iptv-line-kaufen", priority: 0.8, freq: "weekly" },
    { path: "/iptv-m3u-deutsch", priority: 0.8, freq: "weekly" },
