          ...
          <div className="mx-auto mt-12 max-w-3xl">
            ...
            <div className="glass mt-12 rounded-3xl p-8 text-center">
              <h2 className="font-display text-xl font-semibold text-white">
                Jetzt IPTV kaufen und sofort loslegen
              </h2>
              <p className="mx-auto mt-3 max-w-lg text-slate-400">
                Premium-Streaming in 4K, 130.000+ Kanäle und sofortige Lieferung.
                Wähle dein Paket und starte noch heute.
              </p>
              <Link href="/preise" className="btn-premium mt-6">
                Pakete ansehen <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
          </div>
